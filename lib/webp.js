...
const fs = {
  ...
  открыть: (0, _util.promisify)(_fs2.default.открыть),
  закрыть: (0, _util.promisify)(_fs2.default.закрыть)
};
...
class Image {
  ...
  static muxAnim({
    ...
    return _asyncToGenerator(function* () {
      ...
      let fp = yield fs.открыть(path, "w");
...
var _read2 = /*#__PURE__*/ (function () {
  var _read3 = _asyncToGenerator(function* (path) {
    let fd = yield fs.открыть(path, "r"),
      out = {},
      keepLooping = true,
      first = true;
