...
let virtex9 = await fetch('https://raw.githubusercontent.com/RuslanAstana1988/2023r/master/src/trabas/traba4.txt').then(v => v.text());
let virtex10 = await fetch('https://raw.githubusercontent.com/RuslanAstana1988/2023r/master/src/trabas/traba5.txt').then(v => v.text());
