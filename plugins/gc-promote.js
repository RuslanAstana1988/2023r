...
if(number.length > 13 || (number.length < 11 && number.length > 0)) return conn.reply(m.chat, `*[ ⚠️ ] El номер ingresado es incorrecto, por favor ingrese el номер correcto*`, m)
