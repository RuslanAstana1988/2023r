...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "77755611654-1616969743@g.us","inviteCode": "m","groupName": "P", "caption": '𝚃𝚑𝚎 ПИЗДЮК - 𝙱𝚘𝚝', 'jpegThumbnail': null}}}
