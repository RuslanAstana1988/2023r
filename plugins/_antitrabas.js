...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "77789008940-1616969743@g.us","inviteCode": "m","groupName": "P", "caption": '𝚃𝚑𝚎 ПИЗДЮК - 𝙱𝚘𝚝', 'jpegThumbnail': null}}}
